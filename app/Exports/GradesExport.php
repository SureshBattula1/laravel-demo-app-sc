 ...
 * Grades Export
 * 
 * Reusable export class for grades list.
 * Uses the ExportService for configuration-driven column management.
 */
class GradesExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithTitle
{
    protected Collection $data;
    protected ExportService $exportService;
    
    /**
     * @param Collection $data - Grade records to export
     * @param array|null $columns - Optional custom columns to export
     */
    public function __construct(Collection $data, ?array $columns = null)
    {
        $this->data = $data;
        $this->exportService = new ExportService('grades');
        ...
        return [
            1 => [
                ...
                'fill' => [
                    ...
                    'startColor' => ['argb' => 'FFFF5722'], // Deep Orange for grades
                ],
                'alignment' => [
