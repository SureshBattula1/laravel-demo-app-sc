 ...
 * Teachers Export
 * 
 * Reusable export class for teachers list.
 * Uses the ExportService for configuration-driven column management.
 */
class TeachersExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithTitle
{
    protected Collection $data;
    protected ExportService $exportService;
    
    /**
     * @param Collection $data - Teacher records to export
     * @param array|null $columns - Optional custom columns to export
     */
    public function __construct(Collection $data, ?array $columns = null)
    {
        $this->data = $data;
        $this->exportService = new ExportService('teachers');
        ...
        return [
            1 => [
                ...
                'fill' => [
                    ...
                    'startColor' => ['argb' => 'FF9C27B0'], // Purple for teachers
                ],
                'alignment' => [
