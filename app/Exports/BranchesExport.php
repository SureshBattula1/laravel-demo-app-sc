 ...
 * Branches Export
 * 
 * Reusable export class for branches list.
 * Uses the ExportService for configuration-driven column management.
 */
class BranchesExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithTitle
{
    protected Collection $data;
    protected ExportService $exportService;
    
    /**
     * @param Collection $data - Branch records to export
     * @param array|null $columns - Optional custom columns to export
     */
    public function __construct(Collection $data, ?array $columns = null)
    {
        $this->data = $data;
        $this->exportService = new ExportService('branches');
        ...
        return [
            1 => [
                ...
                'fill' => [
                    ...
                    'startColor' => ['argb' => 'FF00BCD4'], // Cyan for branches
                ],
                'alignment' => [
